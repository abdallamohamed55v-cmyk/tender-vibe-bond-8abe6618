...
const categories = [
  {
    ...
    items: [
      { src: "/showcase/img-1.webp", model: "Megsy V1", type: "image" },
      { src: "/showcase/img-2.webp", model: "FLUX Kontext Max", type: "image" },
      { src: "/showcase/img-3.webp", model: "Nano Banana 2", type: "image" },
      { src: "/showcase/img-4.webp", model: "Recraft V4", type: "image" },
      { src: "/showcase/img-5.webp", model: "Ideogram 3", type: "image" },
      { src: "/showcase/img-6.webp", model: "HiDream I1", type: "image" },
    ],
  },
  {
    label: "Video Models",
